...
// itk_forest_build_testbed overlay: ITK main no longer compiles the
// vnl_matrix_exp explicit instantiations into libitkvnl, so make this
// header-only — consumers (elastix AffineLogTransform) instantiate implicitly.
