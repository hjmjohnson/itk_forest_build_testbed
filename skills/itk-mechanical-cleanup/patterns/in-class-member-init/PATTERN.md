---
pattern: in-class-member-init
clang_tidy_check: modernize-use-default-member-init
itk_main_status: merged
itk_main_ref: b21dbbb
...
cannot value-init) must be reverted individually, not in bulk.
